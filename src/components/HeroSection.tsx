      ...
      <div className="flex flex-col items-center justify-center gap-4 lg:flex-row lg:items-start">
        ...
        >
          <h1 className="mb-4 text-4xl font-[700] text-white md:text-5xl lg:leading-normal xl:text-6xl">
            Hi, I&apos;m <span className="text-heading">Shushant</span> a{" "}
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row ">
            <ScrollLink
              ...
              smooth={true}
              duration={1000}
              className="duration-400 w-full cursor-pointer rounded-full bg-white px-6 py-3 text-center text-lg font-bold text-darkHover transition-all duration-500 ease-in-out hover:scale-[0.98] hover:bg-[rgb(76,255,107)] sm:w-fit md:mr-4"
            >
              Hire Me
            </ScrollLink>
